...
kernel = refjax.kernel(abeles) # i.e Abeles matrix formalism, no smearing in the detector (default)
...
plt.yscale("log")
plt.xscale("log")
plt.legend(['Data', '_', '$\pm 3 \sigma$', 'Model (no smearing)'])
plt.show()
...
plt.yscale("log")
plt.xscale("log")
plt.legend(['Data', '_', '$\pm 3 \sigma$', 'Model (Gaussian smearing)'])
plt.show()
