...
def abeles(params, Q):
    ...
    # For some reason manually perfomring the 2x2 matrix multiplications
    ...
    # Perhaps there is an einsum that works better?
    # Tested it and seemingly not. Bizzare behavior.
    # Perhaps constructing the large array (n_layers+1, Q.shape, 2,2) is expensive somehow?
    # Hard to imagine.
